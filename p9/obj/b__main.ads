...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#afeafb67#;
   ...
   u00044 : constant Version_32 := 16#ff5d18bd#;
   pragma Export (C, u00044, "ada__execution_timeB");
   u00045 : constant Version_32 := 16#bd053477#;
   pragma Export (C, u00045, "ada__execution_timeS");
   u00046 : constant Version_32 := 16#ab3df6f3#;
   pragma Export (C, u00046, "ada__task_identificationB");
   u00047 : constant Version_32 := 16#8b7d663f#;
   pragma Export (C, u00047, "ada__task_identificationS");
   u00048 : constant Version_32 := 16#57a37a42#;
   pragma Export (C, u00048, "system__address_imageB");
   u00049 : constant Version_32 := 16#bccbd9bb#;
   pragma Export (C, u00049, "system__address_imageS");
   u00050 : constant Version_32 := 16#176e813d#;
   pragma Export (C, u00050, "system__task_primitivesS");
   u00051 : constant Version_32 := 16#9a3bced2#;
   pragma Export (C, u00051, "system__os_interfaceB");
   u00052 : constant Version_32 := 16#3c12da50#;
   ...
   u00055 : constant Version_32 := 16#66dc3fcb#;
   pragma Export (C, u00055, "system__linuxS");
   u00056 : constant Version_32 := 16#03c1be12#;
   ...
   u00058 : constant Version_32 := 16#6a4f08aa#;
   pragma Export (C, u00058, "system__task_primitives__operationsB");
   u00059 : constant Version_32 := 16#5a266085#;
   pragma Export (C, u00059, "system__task_primitives__operationsS");
   u00060 : constant Version_32 := 16#fa38f350#;
   pragma Export (C, u00060, "interfaces__c__extensionsS");
   u00061 : constant Version_32 := 16#a87ab9e2#;
   pragma Export (C, u00061, "system__bit_opsB");
   u00062 : constant Version_32 := 16#0765e3a3#;
   pragma Export (C, u00062, "system__bit_opsS");
   u00063 : constant Version_32 := 16#66645a25#;
   pragma Export (C, u00063, "system__interrupt_managementB");
   u00064 : constant Version_32 := 16#e75eca89#;
   pragma Export (C, u00064, "system__interrupt_managementS");
   u00065 : constant Version_32 := 16#f65595cf#;
   pragma Export (C, u00065, "system__multiprocessorsB");
   u00066 : constant Version_32 := 16#258bdbf2#;
   pragma Export (C, u00066, "system__multiprocessorsS");
   u00067 : constant Version_32 := 16#be1316da#;
   pragma Export (C, u00067, "system__os_primitivesB");
   u00068 : constant Version_32 := 16#adf6c8a8#;
   ...
   u00074 : constant Version_32 := 16#736c9d9e#;
   pragma Export (C, u00074, "system__taskingB");
   u00075 : constant Version_32 := 16#a0152c3e#;
   pragma Export (C, u00075, "system__taskingS");
   u00076 : constant Version_32 := 16#118e865d#;
   pragma Export (C, u00076, "system__stack_usageB");
   u00077 : constant Version_32 := 16#00bc3311#;
   pragma Export (C, u00077, "system__stack_usageS");
   u00078 : constant Version_32 := 16#d7aac20c#;
   pragma Export (C, u00078, "system__ioB");
   u00079 : constant Version_32 := 16#8365b3ce#;
   pragma Export (C, u00079, "system__ioS");
   u00080 : constant Version_32 := 16#67fbf7ba#;
   pragma Export (C, u00080, "system__tasking__debugB");
   u00081 : constant Version_32 := 16#364be463#;
   ...
   u00087 : constant Version_32 := 16#7c6b4241#;
   ...
   u00090 : constant Version_32 := 16#8539b82b#;
   pragma Export (C, u00090, "system__tasking__utilitiesB");
   u00091 : constant Version_32 := 16#65f77ff8#;
   pragma Export (C, u00091, "system__tasking__utilitiesS");
   u00092 : constant Version_32 := 16#12c8cd7d#;
   ...
   u00095 : constant Version_32 := 16#99e5f76b#;
   pragma Export (C, u00095, "system__htableS");
   u00096 : constant Version_32 := 16#089f5cd0#;
   pragma Export (C, u00096, "system__string_hashB");
   u00097 : constant Version_32 := 16#3bbb9c15#;
   pragma Export (C, u00097, "system__string_hashS");
   u00098 : constant Version_32 := 16#06052bd0#;
   pragma Export (C, u00098, "system__val_lluB");
   u00099 : constant Version_32 := 16#fa8db733#;
   pragma Export (C, u00099, "system__val_lluS");
   u00100 : constant Version_32 := 16#27b600b2#;
   pragma Export (C, u00100, "system__val_utilB");
   u00101 : constant Version_32 := 16#b187f27f#;
   pragma Export (C, u00101, "system__val_utilS");
   u00102 : constant Version_32 := 16#d1060688#;
   pragma Export (C, u00102, "system__case_utilB");
   u00103 : constant Version_32 := 16#392e2d56#;
   pragma Export (C, u00103, "system__case_utilS");
   u00104 : constant Version_32 := 16#5eb4fbb1#;
   pragma Export (C, u00104, "system__tasking__initializationB");
   u00105 : constant Version_32 := 16#d9930fa8#;
   pragma Export (C, u00105, "system__tasking__initializationS");
   u00106 : constant Version_32 := 16#43c86425#;
   pragma Export (C, u00106, "system__soft_links__taskingB");
   u00107 : constant Version_32 := 16#e47ef8be#;
   pragma Export (C, u00107, "system__soft_links__taskingS");
   u00108 : constant Version_32 := 16#17d21067#;
   pragma Export (C, u00108, "ada__exceptions__is_null_occurrenceB");
   u00109 : constant Version_32 := 16#9a9e8fd3#;
   pragma Export (C, u00109, "ada__exceptions__is_null_occurrenceS");
   u00110 : constant Version_32 := 16#9b48686e#;
   pragma Export (C, u00110, "system__tasking__task_attributesB");
   u00111 : constant Version_32 := 16#952bcf5e#;
   pragma Export (C, u00111, "system__tasking__task_attributesS");
   u00112 : constant Version_32 := 16#d7130ad0#;
   pragma Export (C, u00112, "system__tasking__queuingB");
   u00113 : constant Version_32 := 16#3117b7f1#;
   pragma Export (C, u00113, "system__tasking__queuingS");
   u00114 : constant Version_32 := 16#1ae41921#;
   pragma Export (C, u00114, "system__tasking__protected_objectsB");
   u00115 : constant Version_32 := 16#63b50013#;
   pragma Export (C, u00115, "system__tasking__protected_objectsS");
   u00116 : constant Version_32 := 16#ee80728a#;
   pragma Export (C, u00116, "system__tracesB");
   u00117 : constant Version_32 := 16#ef3a2c2b#;
   pragma Export (C, u00117, "system__tracesS");
   u00118 : constant Version_32 := 16#7d7ec024#;
   pragma Export (C, u00118, "system__tasking__protected_objects__entriesB");
   u00119 : constant Version_32 := 16#7671a6ef#;
   pragma Export (C, u00119, "system__tasking__protected_objects__entriesS");
   u00120 : constant Version_32 := 16#100eaf58#;
   pragma Export (C, u00120, "system__restrictionsB");
   u00121 : constant Version_32 := 16#064fcfcf#;
   pragma Export (C, u00121, "system__restrictionsS");
   ...
   u00125 : constant Version_32 := 16#2e6701ab#;
   pragma Export (C, u00125, "ada__streamsS");
   u00126 : constant Version_32 := 16#db5c917c#;
   ...
   u00128 : constant Version_32 := 16#52d53711#;
   ...
   u00131 : constant Version_32 := 16#d2b6cf55#;
   pragma Export (C, u00131, "ada__real_timeB");
   u00132 : constant Version_32 := 16#87ade2f4#;
   pragma Export (C, u00132, "ada__real_timeS");
   u00133 : constant Version_32 := 16#1f99af62#;
   pragma Export (C, u00133, "system__arith_64B");
   u00134 : constant Version_32 := 16#3d59434c#;
   pragma Export (C, u00134, "system__arith_64S");
   u00135 : constant Version_32 := 16#50ea431d#;
   pragma Export (C, u00135, "ada__real_time__delaysB");
   u00136 : constant Version_32 := 16#ad9f57fe#;
   pragma Export (C, u00136, "ada__real_time__delaysS");
   u00137 : constant Version_32 := 16#28f088c2#;
   pragma Export (C, u00137, "ada__text_ioB");
   u00138 : constant Version_32 := 16#f372c8ac#;
   pragma Export (C, u00138, "ada__text_ioS");
   u00139 : constant Version_32 := 16#84a27f0d#;
   pragma Export (C, u00139, "interfaces__c_streamsB");
   u00140 : constant Version_32 := 16#8bb5f2c0#;
   pragma Export (C, u00140, "interfaces__c_streamsS");
   u00141 : constant Version_32 := 16#431faf3c#;
   pragma Export (C, u00141, "system__file_ioB");
   u00142 : constant Version_32 := 16#ba56a5e4#;
   pragma Export (C, u00142, "system__file_ioS");
   u00143 : constant Version_32 := 16#07e6ee66#;
   pragma Export (C, u00143, "system__os_libB");
   u00144 : constant Version_32 := 16#d7b69782#;
   pragma Export (C, u00144, "system__os_libS");
   u00145 : constant Version_32 := 16#1a817b8e#;
   pragma Export (C, u00145, "system__stringsB");
   u00146 : constant Version_32 := 16#639855e7#;
   pragma Export (C, u00146, "system__stringsS");
   u00147 : constant Version_32 := 16#e0b8de29#;
   ...
   u00149 : constant Version_32 := 16#9a7907af#;
   pragma Export (C, u00149, "system__concat_5S");
   u00150 : constant Version_32 := 16#932a4690#;
   pragma Export (C, u00150, "system__concat_4B");
   u00151 : constant Version_32 := 16#63436fa1#;
   pragma Export (C, u00151, "system__concat_4S");
   u00152 : constant Version_32 := 16#46899fd1#;
   pragma Export (C, u00152, "system__concat_7B");
   u00153 : constant Version_32 := 16#e1e01f9e#;
   pragma Export (C, u00153, "system__concat_7S");
   u00154 : constant Version_32 := 16#a83b7c85#;
   pragma Export (C, u00154, "system__concat_6B");
   u00155 : constant Version_32 := 16#cfe06933#;
   pragma Export (C, u00155, "system__concat_6S");
   u00156 : constant Version_32 := 16#1a9afbf1#;
   pragma Export (C, u00156, "system__tasking__stagesB");
   u00157 : constant Version_32 := 16#b3806b84#;
   pragma Export (C, u00157, "system__tasking__stagesS");
   u00158 : constant Version_32 := 16#7f10ce87#;
   ...
   u00160 : constant Version_32 := 16#3104380a#;
   ...
   u00162 : constant Version_32 := 16#2c5eeaff#;
   ...
   u00164 : constant Version_32 := 16#7ebd8839#;
   pragma Export (C, u00164, "system__val_intB");
   u00165 : constant Version_32 := 16#55826ebe#;
   pragma Export (C, u00165, "system__val_intS");
   u00166 : constant Version_32 := 16#b44f9ae7#;
   pragma Export (C, u00166, "system__val_unsB");
   u00167 : constant Version_32 := 16#90d70d7a#;
   pragma Export (C, u00167, "system__val_unsS");
   u00168 : constant Version_32 := 16#9d39c675#;
   pragma Export (C, u00168, "system__memoryB");
   u00169 : constant Version_32 := 16#445a22b5#;
