...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#6cfe5906#;
   pragma Export (C, u00001, "mainB");
   u00002 : constant Version_32 := 16#fbff4c67#;
   pragma Export (C, u00002, "system__standard_libraryB");
   u00003 : constant Version_32 := 16#1ec6fd90#;
   pragma Export (C, u00003, "system__standard_libraryS");
   u00004 : constant Version_32 := 16#d2b6cf55#;
   ...
   u00045 : constant Version_32 := 16#3d59434c#;
   pragma Export (C, u00045, "system__arith_64S");
   u00046 : constant Version_32 := 16#736c9d9e#;
   ...
   u00050 : constant Version_32 := 16#3c12da50#;
   ...
   u00054 : constant Version_32 := 16#03c1be12#;
   ...
   u00056 : constant Version_32 := 16#6a4f08aa#;
   ...
   u00072 : constant Version_32 := 16#67fbf7ba#;
   ...
   u00098 : constant Version_32 := 16#4747c023#;
   pragma Export (C, u00098, "controladorB");
   u00099 : constant Version_32 := 16#2453d784#;
   pragma Export (C, u00099, "controladorS");
   u00100 : constant Version_32 := 16#8f4c2033#;
   pragma Export (C, u00100, "system__interruptsB");
   u00101 : constant Version_32 := 16#578f5777#;
   pragma Export (C, u00101, "system__interruptsS");
   u00102 : constant Version_32 := 16#ab3df6f3#;
   pragma Export (C, u00102, "ada__task_identificationB");
   u00103 : constant Version_32 := 16#8b7d663f#;
   pragma Export (C, u00103, "ada__task_identificationS");
   u00104 : constant Version_32 := 16#57a37a42#;
   pragma Export (C, u00104, "system__address_imageB");
   u00105 : constant Version_32 := 16#bccbd9bb#;
   pragma Export (C, u00105, "system__address_imageS");
   u00106 : constant Version_32 := 16#8539b82b#;
   pragma Export (C, u00106, "system__tasking__utilitiesB");
   u00107 : constant Version_32 := 16#65f77ff8#;
   pragma Export (C, u00107, "system__tasking__utilitiesS");
   u00108 : constant Version_32 := 16#5eb4fbb1#;
   pragma Export (C, u00108, "system__tasking__initializationB");
   u00109 : constant Version_32 := 16#d9930fa8#;
   pragma Export (C, u00109, "system__tasking__initializationS");
   u00110 : constant Version_32 := 16#43c86425#;
   pragma Export (C, u00110, "system__soft_links__taskingB");
   u00111 : constant Version_32 := 16#e47ef8be#;
   ...
   u00113 : constant Version_32 := 16#9a9e8fd3#;
   pragma Export (C, u00113, "ada__exceptions__is_null_occurrenceS");
   u00114 : constant Version_32 := 16#9b48686e#;
   pragma Export (C, u00114, "system__tasking__task_attributesB");
   u00115 : constant Version_32 := 16#952bcf5e#;
   pragma Export (C, u00115, "system__tasking__task_attributesS");
   u00116 : constant Version_32 := 16#d7130ad0#;
   pragma Export (C, u00116, "system__tasking__queuingB");
   u00117 : constant Version_32 := 16#3117b7f1#;
   pragma Export (C, u00117, "system__tasking__queuingS");
   u00118 : constant Version_32 := 16#1ae41921#;
   pragma Export (C, u00118, "system__tasking__protected_objectsB");
   u00119 : constant Version_32 := 16#63b50013#;
   pragma Export (C, u00119, "system__tasking__protected_objectsS");
   u00120 : constant Version_32 := 16#ee80728a#;
   pragma Export (C, u00120, "system__tracesB");
   u00121 : constant Version_32 := 16#ef3a2c2b#;
   pragma Export (C, u00121, "system__tracesS");
   u00122 : constant Version_32 := 16#7d7ec024#;
   pragma Export (C, u00122, "system__tasking__protected_objects__entriesB");
   u00123 : constant Version_32 := 16#7671a6ef#;
   pragma Export (C, u00123, "system__tasking__protected_objects__entriesS");
   u00124 : constant Version_32 := 16#100eaf58#;
   pragma Export (C, u00124, "system__restrictionsB");
   u00125 : constant Version_32 := 16#064fcfcf#;
   pragma Export (C, u00125, "system__restrictionsS");
   u00126 : constant Version_32 := 16#b7ab275c#;
   pragma Export (C, u00126, "ada__finalizationB");
   u00127 : constant Version_32 := 16#19f764ca#;
   ...
   u00132 : constant Version_32 := 16#52d53711#;
   pragma Export (C, u00132, "system__finalization_rootS");
   u00133 : constant Version_32 := 16#bd6fc52e#;
   pragma Export (C, u00133, "system__traces__taskingB");
   u00134 : constant Version_32 := 16#3fb127e5#;
   pragma Export (C, u00134, "system__traces__taskingS");
   u00135 : constant Version_32 := 16#7ecd9d2b#;
   pragma Export (C, u00135, "system__interrupt_management__operationsB");
   u00136 : constant Version_32 := 16#19b909c9#;
   pragma Export (C, u00136, "system__interrupt_management__operationsS");
   u00137 : constant Version_32 := 16#c684e35a#;
   pragma Export (C, u00137, "system__task_primitives__interrupt_operationsB");
   u00138 : constant Version_32 := 16#19416642#;
   pragma Export (C, u00138, "system__task_primitives__interrupt_operationsS");
   u00139 : constant Version_32 := 16#7f10ce87#;
   pragma Export (C, u00139, "system__tasking__rendezvousB");
   u00140 : constant Version_32 := 16#71fce298#;
   pragma Export (C, u00140, "system__tasking__rendezvousS");
   u00141 : constant Version_32 := 16#3104380a#;
   pragma Export (C, u00141, "system__tasking__entry_callsB");
   u00142 : constant Version_32 := 16#e903595c#;
   pragma Export (C, u00142, "system__tasking__entry_callsS");
   u00143 : constant Version_32 := 16#2c5eeaff#;
   pragma Export (C, u00143, "system__tasking__protected_objects__operationsB");
   u00144 : constant Version_32 := 16#eb67f071#;
   pragma Export (C, u00144, "system__tasking__protected_objects__operationsS");
   u00145 : constant Version_32 := 16#1a9afbf1#;
   pragma Export (C, u00145, "system__tasking__stagesB");
   u00146 : constant Version_32 := 16#b3806b84#;
   pragma Export (C, u00146, "system__tasking__stagesS");
   u00147 : constant Version_32 := 16#6c4a01f5#;
   pragma Export (C, u00147, "ada__interruptsB");
   u00148 : constant Version_32 := 16#207c07f5#;
   pragma Export (C, u00148, "ada__interruptsS");
   u00149 : constant Version_32 := 16#a77bab69#;
   pragma Export (C, u00149, "ada__interrupts__namesS");
   ...
   u00153 : constant Version_32 := 16#9d39c675#;
   pragma Export (C, u00153, "system__memoryB");
   u00154 : constant Version_32 := 16#445a22b5#;
